...
class TaskSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $workStart = config('app.work_schedule.start');
        $workEnd = config('app.work_schedule.end');
        $workDays = array_map(
            'intval',
            explode(',', config('app.work_schedule.days')),
        );
        ...
        foreach (range(1, 30) as $i) {
            ...
            $task = Task::create([
                ...
                'starts_at' => $startsAt,
                'ends_at' => $isCompleted || fake()->boolean(40) ? $endsAt : null,
